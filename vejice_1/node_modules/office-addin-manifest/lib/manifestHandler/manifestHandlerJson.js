...
class ManifestHandlerJson extends manifestHandler_1.ManifestHandler {
    modifyManifest(guid, displayName) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const appManifest = (yield app_manifest_1.AppManifestUtils.readTeamsManifest(this.manifestPath));
    ...
    parseManifest() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const file = (yield app_manifest_1.AppManifestUtils.readTeamsManifest(this.manifestPath));
    ...
    writeManifestData(manifestData) {
        return __awaiter(this, void 0, void 0, function* () {
            yield app_manifest_1.AppManifestUtils.writeTeamsManifest(this.manifestPath, manifestData);
        });
    }
}
