 ...
 */
export async function removePlugin({ pluginName, cleanOutput, workingDirectory }) {
    const result = await connectToKiota(async (connection) => {
        const request = new rpc.RequestType2("RemovePlugin");
 ...
 */
export async function removeClient({ clientName, cleanOutput, workingDirectory }) {
    const result = await connectToKiota(async (connection) => {
        const request = new rpc.RequestType2("RemoveClient");
