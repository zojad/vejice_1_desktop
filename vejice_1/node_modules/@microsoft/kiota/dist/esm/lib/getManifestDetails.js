 ...
 */
export async function getManifestDetails({ manifestPath, clearCache, apiIdentifier }) {
    const result = await connectToKiota(async (connection) => {
        const request = new rpc.RequestType('GetManifestDetails');
...
;
//# sourceMappingURL=getManifestDetails.js.map