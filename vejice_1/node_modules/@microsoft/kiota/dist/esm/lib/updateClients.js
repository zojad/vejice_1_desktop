 ...
 */
export async function updateClients({ cleanOutput, clearCache, workspacePath }) {
    const result = await connectToKiota(async (connection) => {
        const request = new rpc.RequestType3("Update");
        return await connection.sendRequest(request, workspacePath, cleanOutput, clearCache);
    });
