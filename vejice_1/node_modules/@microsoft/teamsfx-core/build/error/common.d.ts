...
export declare class DeclarativeAgentPathNotFoundError extends UserError {
    constructor(manifestPath: string);
}
export declare class ActionNotFoundError extends UserError {
    constructor(declarativeAgentPath: string);
}
export declare class SpecNotFoundError extends UserError {
    constructor(pluginPath: string);
}
export declare class OriginalSpecNotFoundError extends UserError {
...
export declare class NeedRedoError extends UserError {
    constructor(source: string);
}
...
export declare class MFARequiredError extends UserError {
    constructor(source: string);
}
...
export declare class MigrationError extends UserError {
...
export declare class UpgradeV3CanceledError extends UserError {
    constructor();
}
export declare class IncompatibleProjectError extends UserError {
    constructor(messageKey: string);
}
export declare class AbandonedProjectError extends UserError {
    constructor();
}
export declare class FailedToParseResourceIdError extends UserError {
    constructor(name: string, resourceId: string);
}
export declare class NpmInstallError extends SystemError {
    constructor(e: Error, source?: string);
}
export declare class FileNotSupportError extends UserError {
