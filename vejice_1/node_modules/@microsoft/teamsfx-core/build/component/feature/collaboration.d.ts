...
import { AadOwner, AgentOwner, ResourcePermission, TeamsAppAdmin } from "../../common/permissionInterface";
...
export declare class AgentCollaboration {
    private readonly tokenProvider;
    constructor(m365TokenProvider: M365TokenProvider);
    grantPermission(ctx: Context, titleId: string, userInfo: AppUser): Promise<Result<ResourcePermission[], FxError>>;
    listCollaborator(ctx: Context, titleId: string): Promise<Result<AgentOwner[], FxError>>;
}
