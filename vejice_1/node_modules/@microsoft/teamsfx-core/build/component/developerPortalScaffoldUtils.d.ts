...
export declare function updateEnv(appId: string, projectPath: string): Promise<Result<undefined, FxError>>;
export declare function adjustScopeBasedOnVersion(scopes: string[], version: string): string[];
