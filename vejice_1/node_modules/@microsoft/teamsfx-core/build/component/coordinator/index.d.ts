...
import { ExecutionError, ExecutionOutput, ProjectModel } from "../configManager/interface";
...
export declare function showAadResourceLink(ctx: DriverContext, isAadUpdateAction: boolean, projectModel: ProjectModel, clientId?: string): void;
export declare function openUrl(ctx: DriverContext, url: string): void;
export {};
