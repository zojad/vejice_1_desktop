...
export declare function resolve(input: unknown, resolved: ResolvedPlaceholders, unresolved: UnresolvedPlaceholders): unknown;
export declare const allowedEmptyKeys: string[];
